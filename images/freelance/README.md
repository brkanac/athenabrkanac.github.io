...
appear on `photography.html` automatically. You do not need to edit any
...
`photography.html` for where to paste the embed code.
...
Copy a `<div class="shot-group">` block in `photography.html`. Give it a
